...
seqedit::fill_top_bar( void )
{
    ...
    m_button_bpm->signal_clicked().connect(  sigc::bind( mem_fun( *this, &seqedit::popup_menu), m_menu_bpm  ));
    ...
    m_button_bw->signal_clicked().connect(  sigc::bind( mem_fun( *this, &seqedit::popup_menu), m_menu_bw  ));
    ...
    m_button_length->signal_clicked().connect(  sigc::bind( mem_fun( *this, &seqedit::popup_menu), m_menu_length  ));
    ...
    m_button_channel->signal_clicked().connect(  mem_fun( *this, &seqedit::popup_midich_menu ));
    ...
    m_button_note_length->signal_clicked().connect(  sigc::bind( mem_fun( *this, &seqedit::popup_menu), m_menu_note_length  ));
    ...
    m_button_zoom->signal_clicked().connect(  sigc::bind( mem_fun( *this, &seqedit::popup_menu), m_menu_zoom  ));
    ...
    m_button_key->signal_clicked().connect(  sigc::bind( mem_fun( *this, &seqedit::popup_menu), m_menu_key  ));
