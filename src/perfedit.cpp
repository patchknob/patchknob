...
perfedit::perfedit( perform *a_perf ) 
{
    ...
    m_button_bpm->signal_clicked().connect(  bind( mem_fun( *this, &perfedit::popup_menu), m_menu_bpm  ));
    ...
    m_button_bw->signal_clicked().connect(  bind( mem_fun( *this, &perfedit::popup_menu), m_menu_bw  ));
